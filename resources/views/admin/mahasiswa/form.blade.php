<div class="form-group {{ $errors->has('nim_mahasiswa') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="nim_mahasiswa" type="text" id="nim_mahasiswa" value="{{ isset($mahasiswa->nim_mahasiswa) ? $mahasiswa->nim_mahasiswa : ''}}" >
...
<div class="form-group {{ $errors->has('nama_mahasiswa') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="nama_mahasiswa" type="text" id="nama_mahasiswa" value="{{ isset($mahasiswa->nama_mahasiswa) ? $mahasiswa->nama_mahasiswa : ''}}" >
...
<div class="form-group {{ $errors->has('alamat_rumah_mahasiswa') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="alamat_rumah_mahasiswa" type="text" id="alamat_rumah_mahasiswa" value="{{ isset($mahasiswa->alamat_rumah_mahasiswa) ? $mahasiswa->alamat_rumah_mahasiswa : ''}}" >
